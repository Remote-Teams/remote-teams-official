...
var modelName = 'Wsubtasks';

const wsubtaskSchema = new mongoose.Schema({
...
wsubtaskSchema.index({'$**': 'text'});

wsubtaskSchema.plugin(uniqueValidator);

wsubtaskSchema.statics = {
...
const Wsubtask = mongoose.model(modelName, wsubtaskSchema);

module.exports = Wsubtask;