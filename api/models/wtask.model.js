...
var modelName = 'Wtasks';

const wtaskSchema = new mongoose.Schema({
...
wtaskSchema.index({'$**': 'text'});

wtaskSchema.plugin(uniqueValidator);
...
const Wtask = mongoose.model(modelName, wtaskSchema);

module.exports = Wtask;