...
import AddNewScheduleOnCellClickDayOff from "./AddNewScheduleOnCellClickDayOff";
import AddNewScheduleOnCellClickMeeting from "./AddNewScheduleOnCellClickMeeting";
...
// ];
function AddNewDashboardScheduleOnCellClick({
  bookCalenderModel,
  onCloseModal,
  bookOnCellClickData,
}) {
        ...
        <div className="add-new-schedule-div">
          ...
          <div className="add-new-schedule-tabs mt-70">
            <Tabs>
              ...
              <TabPanel>
                <AddNewScheduleOnCellClickMeeting
                  bookOnCellClickData={bookOnCellClickData}
                  onCloseModal={onCloseModal}
                />
              </TabPanel>
              <TabPanel>
                <AddNewScheduleOnCellClickDayOff
                  bookOnCellClickData={bookOnCellClickData}
                  onCloseModal={onCloseModal}
                />
              </TabPanel>
...
export default AddNewDashboardScheduleOnCellClick;
