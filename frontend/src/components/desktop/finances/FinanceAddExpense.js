...
import { addExpanses } from "./../../../store/actions/financeAction";
import { withRouter } from "react-router-dom";
import { getAllProjectAction } from "./../../../store/actions/projectAction";
import { validateAddExpense } from "./../../../store/validations/financeValidation/addExpenseValidation";
...
class FinanceAddExpense extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // renderRow1
  ...
  handleOnClickAdd = (status) => (e) => {
    ...
    const { errors, isValid } = validateAddExpense(this.state);
    ...
    if (!isValid) {
      ...
      this.props.addExpanses(formData, this.props.history);
    }
  };
  /*=================================================================
      renderRow1
      ...
      <div className="row mx-0 add-expense-row-1">
        <div className="col-4">
          <InputFieldEmailTextPassword
            ...
            type="text"
            error={!isEmpty(errors.payeeName) && errors.payeeName}
          />
        </div>
        <div className="col-8">
