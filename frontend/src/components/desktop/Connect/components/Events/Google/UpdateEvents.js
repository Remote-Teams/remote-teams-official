...
export class CreateEvents extends Component {
    ...
    componentDidMount(){
        ...
        console.log( events );
        this.setState({
            summary:events.summary ? events.summary : "",
            description: events.description ? events.description : "",
            location:events.location ? events.location : "",
    ...
    onSaveHandler = e => {
        ...
        if( formData.attendees[0].email == "" ){
            delete formData.attendees;
        }
        this.onClose();
