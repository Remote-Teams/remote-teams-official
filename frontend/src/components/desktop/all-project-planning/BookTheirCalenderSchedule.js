...
import BookCalenderAddScheduleOnCellClick from "./BookCalenderAddScheduleOnCellClick";
...
export class BookTheirCalenderSchedule extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        /> */}
        <BookCalenderAddScheduleOnCellClick
