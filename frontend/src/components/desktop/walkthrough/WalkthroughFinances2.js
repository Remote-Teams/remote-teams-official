...
class WalkthroughFinances2 extends Component {
  constructor() {
    super();
    this.state = {
      open: true,
      ...
      <Fragment>
        ...
        <Modal
          ...
          classNames={{
            ...
            modal:
              "customModal customModal--walkthrough customModal--walkthrough-finance-2",
              ...
              <div className="row mx-0">
                <div className="col-9 px-0">
                  <h2 className="new-walkthrough__title">
                    This is your finances navigation
                  </h2>
                </div>
                <div className="col-9 px-0">
                  <p className="new-walkthrough__desc new-walkthrough__desc--opacity-81">
                    You can go to these 4 sections using this navigation.
                  </p>
