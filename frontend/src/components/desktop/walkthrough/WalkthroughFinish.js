              ...
              <div className="row mx-0">
                <div className="col-9 px-0">
                  <h2 className="new-walkthrough__title">
                    That Concludes our walkthrough
                  </h2>
                </div>
                <div className="col-9 px-0">
                  <p className="new-walkthrough__desc new-walkthrough__desc--opacity-81">
                    If you need any help you can always chat with our help
                    assistant " ". He will be happy to help!
                  </p>
                  <p className="new-walkthrough__desc new-walkthrough__desc--opacity-51">
                    You can always rerun this later via Profile.
                  </p>
                ...
                <div className="col-3 px-0 text-center align-self-center">
                  <img
                    src={require("../../../assets/img/walkthrough/icons/finish.svg")}
                    alt=""
