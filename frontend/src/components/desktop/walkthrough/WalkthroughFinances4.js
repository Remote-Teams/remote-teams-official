...
class WalkthroughFinances4 extends Component {
  constructor() {
    super();
    this.state = {
      open: true,
              ...
              <div className="row mx-0">
                <div className="col-9 px-0">
                  <h2 className="new-walkthrough__title">
                    Let's move over to expenses.
                  </h2>
                </div>
                <div className="col-9 px-0">
                  <p className="new-walkthrough__desc new-walkthrough__desc--opacity-81">
                    This is where you can manage your organizations' expenses
                    including Project and Miscellaneous expenses.
                  </p>
                  <p className="new-walkthrough__desc new-walkthrough__desc--white">
                    Lets go to expenses tab next.
                  </p>
