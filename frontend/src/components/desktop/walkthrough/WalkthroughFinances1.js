...
class WalkthroughFinances1 extends Component {
  constructor() {
    super();
    this.state = {
      open: true,
      ...
      <Fragment>
        ...
        <Modal
          ...
          classNames={{
            ...
            modal:
              "customModal customModal--walkthrough customModal--walkthrough-finance-1",
              ...
              <div className="row mx-0">
                <div className="col-9 px-0">
                  <h2 className="new-walkthrough__title">
                    Now let's take a look at the finance section
                  </h2>
                </div>
                <div className="col-9 px-0">
                  <p className="new-walkthrough__desc opacity-81">
                    This is where you can see all the your information related
                    to, invoices, expenses etc.
                  </p>
                  <p className="new-walkthrough__desc opacity-51">
                    You can use this icon later to navigate to Resources section
                  </p>
