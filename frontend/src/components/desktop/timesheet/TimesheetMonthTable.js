...
import TimesheetMonthTableTotalHoursPerDay from "./TimesheetMonthTableTotalHoursPerDay";
...
export class TimesheetMonthTable extends Component {
  constructor() {
    super();
    this.state = {
      actualHours: "",
        ...
        <div className="row mx-0 flex-nowrap align-items-center timesheet-day-view-progress-row1-colm1">
          ...
          {/* {dataStatus.value === "ANSWERED" ? (
            ...
            <Select
              ...
              //   (a) => a.value === dataStatus.value
              // )}
              onChange={this.handleChangeStatusDropdownTable(dataStatus)}
  ...
  render() {
    ...
    return (
      <div className="timesheet-day-view-div">
          ...
          <table className="finances-table finances-table--timesheetMonth">
            <thead>
              <tr>
                ...
                <th>
                  <span>total hours per task</span>
                </th>
              </tr>
            </thead>
          </table>
        ...
        {!isEmpty(monthViewTimesheetData) && (
          <TimesheetMonthTableTotalHoursPerDay
            dateArray={dateArray}
