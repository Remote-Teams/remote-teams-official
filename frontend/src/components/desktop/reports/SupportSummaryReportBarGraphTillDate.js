...
class SupportSummaryReportBarGraphTillDate extends Component {
  constructor() {
    super();
    this.state = {};
  }
  ...
  render() {
    ...
    let ticketSummaryTillDate =
      !isEmpty(ticketSummaryChart) && ticketSummaryChart.chartDataTillDate;

    // console.log(ticketSummaryTillDate);
    ...
    const data = (canvas) => {
      ...
      return {
        labels: !isEmpty(ticketSummaryTillDate) && ticketSummaryTillDate.label,
        datasets: [
          {
            label: "",
            backgroundColor: [gradient1, gradient2],
            data: !isEmpty(ticketSummaryTillDate) && ticketSummaryTillDate.data,
            borderWidth: 0,
          },
        ],
      };
