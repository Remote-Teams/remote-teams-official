...
class ClientsDetailsReportPieChartProjectSummary extends Component {
  constructor() {
    super();
    this.state = {};
  }
  ...
  render() {
    ...
    const data = (canvas) => {
      ...
      gradient1.addColorStop(0.2, "#A7BFE8");
      gradient1.addColorStop(0.1, "#6190E8");

      const gradient2 = ctx.createLinearGradient(0, 0, 0, 1000);
      gradient2.addColorStop(0, "#1E75D9");
      gradient2.addColorStop(0.1, "#4B1CCA");
