...
class ProjectStatusReportBudgetGraph extends Component {
  constructor() {
    super();
    this.state = {};
  }
  ...
  render() {
    ...
    const data = (canvas) => {
      ...
      gradient1.addColorStop(0.1, "rgba(168, 255, 120, 1)");
      gradient1.addColorStop(0.2, "rgba(120, 255, 214, 1)");

      const gradient2 = ctx.createLinearGradient(0, 0, 0, 1000);
      gradient2.addColorStop(0, "rgba(17, 153, 142, 1)");
      gradient2.addColorStop(0.2, "rgba(56, 239, 125, 1)");
...
export default connect(mapStateToProps, {})(ProjectStatusReportBudgetGraph);
