...
import VerticalSpliter from "./../lib/components/taskList/VerticalSpliter";
import Header from "./components/header/Headers";
import DataViewPort from "./../lib/components/viewport/DataViewPort";
import LinkViewPort from "./../lib/components/links/LinkViewPort";
import TaskList from "./../lib/components/taskList/TaskList";
import Registry from "./../lib/helpers/registry/Registry";
...
class TimeLine extends Component {
  ...
  doMouseDown = (e) => {
    ...
    // console.log("dom mouse down");
  };
  doMouseMove = (e) => {
    // console.log("dom mouse move");
    if (this.dragging) {
  ...
  doMouseMoveForNextButton = (e) => {
    console.log("dom mouse move");
    if (this.dragging) {
      // let delta = this.draggingPosition - e.clientX;
      let delta = this.draggingPosition - 145;
  ...
  nextHanlder = (e) => {
    ...
    this.dragging = true;
    this.draggingPosition = 300;

    this.doMouseMoveForNextButton(e);
  };
