...
describe("Testing Firing Events ", function () {
  ...
  it("Move and handle mouse event properly", () => {
    ...
    wrapper
      .instance()
      .doMouseDown(
        { button: 1, clientX: 10, stopPropagation: stopPropagation },
        MODE_MOVE
      );
    ...
    wrapper
      .instance()
      .doMouseDown(
        { button: 0, clientX: 10, stopPropagation: stopPropagation },
        MODE_MOVE
      );
  ...
  it("Starting Creation of Task", () => {
    ...
    taskSide
      .first()
      .simulate("mousedown", { button: 0, stopPropagation: stopPropagation });
  ...
  it("Finishing Creation of Task", () => {
    ...
    taskSide
      .first()
      .simulate("mouseup", { button: 0, stopPropagation: stopPropagation });
