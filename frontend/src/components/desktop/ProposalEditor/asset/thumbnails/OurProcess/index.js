...
export default [
  {
    ...
    headline:
      "<h1><span style='font-size:36px'><strong>OUR PROCESS</strong></span></h1>",
    backgroundColor: "#282F32",
    // image_one_src:require('./img/1.png'),
    image_one_src: `${url}/public/download?filename=file-2020-08-04T08:14:25.105Z.png`,
    image_one_width: "100%",
    image_one_crop: { unit: "%" },
    display_logo: false,
  ...
  {
    id: "our_process_template_two",
    thumbnail: require("./2.png"),
    headline:
      "<h1><span style='font-size:36px'><strong>OUR PROCESS</strong></span></h1>",
    backgroundColor: "#282F32",
    // image_one_src:require('./img/1.png'),
    image_one_src: `${url}/public/download?filename=file-2020-08-04T08:15:15.426Z.png`,
    image_one_width: "100%",
    image_one_crop: { unit: "%" },
    display_logo: false,
    icon_name_one: "fa-crop",
