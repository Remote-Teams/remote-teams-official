...
export default [
  {
    ...
    headline:
      "<h1><span style='font-size:36px'><strong>CONTACT US</strong></span></h1>",
    backgroundColor: "#282F32",
    // image_one_src:require('./img/1.png'),
    image_one_src: `${url}/public/download?filename=file-2020-08-10T16:56:15.053Z.png`,
    image_one_width: "100%",
    image_one_crop: { unit: "%" },
    display_logo: false,
  ...
  },
  {
    ...
    backgroundColor: "#282F32",
    // image_one_src:require('./img/1.png'),
    image_one_src: `${url}/public/download?filename=file-2020-08-11T08:18:18.133Z.png`,
    image_one_width: "100%",
    image_one_crop: { unit: "%" },
    display_logo: false,
    icon_name_one: "fa-crop",
