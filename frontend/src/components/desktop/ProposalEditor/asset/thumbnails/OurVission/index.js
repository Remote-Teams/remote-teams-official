...
export default [
  {
    id: "our_vision_template_one",
    thumbnail: require("./1.png"),
    headline:
      "<h1><span style='font-size:36px'><strong>OUR VISION</strong></span></h1>",
    backgroundColor: "#282F32",
    // image_one_src:require('./img/1.png'),
    image_one_src: `${url}/public/download?filename=file-2020-08-10T16:48:11.569Z.png`,
    image_one_width: "100%",
    image_one_crop: { unit: "%" },
    display_logo: false,
  ...
  {
    id: "our_vision_template_two",
    thumbnail: require("./2.png"),
    headline:
      "<h1><span style='font-size:36px'><strong>OUR VISION</strong></span></h1>",
    backgroundColor: "#282F32",
    // image_one_src:require('./img/1.png'),
    image_one_src: `${url}/public/download?filename=file-2020-08-10T16:48:56.493Z.png`,
    image_one_width: "100%",
    image_one_crop: { unit: "%" },
    display_logo: false,
    icon_name_one: "fa-crop",
