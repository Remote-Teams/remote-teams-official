...
export class OurProcess_TemplateTwo extends Component {
  render() {
    return (
...
export default OurProcess_TemplateTwo;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      ...
      className="our_process_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_process_template_two_headline">
        <TextComponent
      ...
      <div className="our_process_template_two_img">
        <ImageComponent
      ...
      <div className="our_process_template_two_para">
        <TextComponent
