...
export const TemplateArea = ( props ) => {
    ...
    return (
        <div id="about_us_template_three" className="au_template_three template_main_container_display_area" style={{ backgroundColor:backgroundColor }}>
            <div className="au_template_three__top">
                ...
                <div className="au_template_three__top__line"><div></div></div>
            </div>
            <div className="au_template_three__blocks_bottom">
                <div className="au_template_three_text_holder">
                    <TextComponent
                ...
                <div className="au_template_three_image_holder">
                <ImageComponent
