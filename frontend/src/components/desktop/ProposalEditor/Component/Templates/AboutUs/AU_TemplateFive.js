...
export class AU_TemplateFive extends Component {
    render() {
        return (
...
export default AU_TemplateFive;

export const TemplateArea = ( props ) => {
    const backgroundColor = props.template_data.backgroundColor;
    // console.log( props.template_data );
    return (
        <div id="about_us_template_five" className="au_template_five template_main_container_display_area" style={{ backgroundColor:backgroundColor }}>
            <div className="au_template_five__top">
                <div className="au_template_five__top__headline">
                    <TextComponent
                ...
                <div className="au_template_five__top__line"><div></div></div>
            </div>
            <div className="au_template_five__blocks_bottom">
                <div className="au_template_five_image_holder">
                    <ImageComponent
                ...
                <div className="au_template_five_text_holder">
                    <TextComponent
