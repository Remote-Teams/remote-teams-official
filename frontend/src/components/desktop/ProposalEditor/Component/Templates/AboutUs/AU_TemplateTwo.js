...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      <div className="au_template_two__middle__left">
        <ImageComponent
      ...
      <div className="au_template_two__middle__right">
        <div className="au_template_two__top_headline">
          <TextComponent
        ...
        <div className="au_template_two__right_inner">
