...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      <div className="what_we_do_template_two_left">
        <ImageComponent
      ...
      <div className="what_we_do_template_two_right">
        <div className="what_we_do_template_two_headline">
          <TextComponent
        ...
        <div className="what_we_do_template_two_para">
          <TextComponent
