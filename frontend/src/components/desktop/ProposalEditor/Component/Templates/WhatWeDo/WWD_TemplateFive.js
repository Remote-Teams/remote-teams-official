...
export class WWD_TemplateFive extends Component {
    render() {
        return (
...
export default WWD_TemplateFive;

export const TemplateArea = ( props ) => {
    const backgroundColor = props.template_data.backgroundColor;
    // console.log( props.template_data );
    return (
        <div id="what_we_do_template_five" className="what_we_do_template_five template_main_container_display_area" style={{ backgroundColor:backgroundColor }}>
            <div className="what_we_do_template_five__top">
                ...
                <div className="what_we_do__top__line"><div></div></div>
            </div>
            <div className="what_we_do_template_five__bottom">
                <div className="what_we_do_template_five__bottom_blocks">
                    <div className="what_we_do_template_five__bottom_blocks_small">
                        <div className="what_we_do_template_five__bottom_blocks__left">
                            <IconComponent
                                ...
                                onTemplateItemChangeWithoutEvent={ props.onTemplateItemChangeWithoutEvent }
                                template_index={ props.template_index }
                                noEditMode={ props.noEditMode }
                            />
                        </div>
                        <div className="what_we_do_template_five__bottom_blocks__right">
                            <div className="what_we_do_template_five__bottom_blocks__right_headline">
                                <TextComponent
                            ...
                            <div className="what_we_do_template_five__bottom_blocks__right_para">
                                <TextComponent
                        ...
                        <div className="what_we_do_template_five__bottom_blocks__right">
                            <div className="what_we_do_template_five__bottom_blocks__right_headline">
                                <TextComponent
                                    ...
                                    noEditMode={props.noEditMode}
                                    onChange={ props.onTemplateEditorChangeHandler("para_four_headline", props.template_index) }
                                />
                            </div>
                            <div className="what_we_do_template_five__bottom_blocks__right_para">
                                <TextComponent
                                    ...
                                    noEditMode={props.noEditMode}
                                    onChange={ props.onTemplateEditorChangeHandler("para_four_text", props.template_index) }
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="what_we_do_template_five__bottom_blocks__right">
                            <div className="what_we_do_template_five__bottom_blocks__right_headline">
                                <TextComponent
                                    ...
                                    noEditMode={props.noEditMode}
                                    onChange={ props.onTemplateEditorChangeHandler("para_five_headline", props.template_index) }
                                />
                            </div>
                            <div className="what_we_do_template_five__bottom_blocks__right_para">
                                <TextComponent
                                    ...
                                    noEditMode={props.noEditMode}
                                    onChange={ props.onTemplateEditorChangeHandler("para_five_text", props.template_index) }
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="what_we_do_template_five__bottom_blocks__right">
                            <div className="what_we_do_template_five__bottom_blocks__right_headline">
                                <TextComponent
                                    ...
                                    noEditMode={props.noEditMode}
                                    onChange={ props.onTemplateEditorChangeHandler("para_six_headline", props.template_index) }
                                />
                            </div>
                            <div className="what_we_do_template_five__bottom_blocks__right_para">
                                <TextComponent
                                    ...
                                    noEditMode={props.noEditMode}
                                    onChange={ props.onTemplateEditorChangeHandler("para_six_text", props.template_index) }
                                />
                            </div>
                        </div>
                    </div>
