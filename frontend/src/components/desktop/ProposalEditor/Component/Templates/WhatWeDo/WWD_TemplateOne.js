...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      <div className="what_we_do_template_one_left">
        <ImageComponent
      ...
      <div className="what_we_do_template_one_right">
        <div className="what_we_do_template_one_headline">
          <TextComponent
        ...
        <div className="what_we_do_template_one_para">
          <TextComponent
