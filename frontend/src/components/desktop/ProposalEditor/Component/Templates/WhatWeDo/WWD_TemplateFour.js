...
export const TemplateArea = ( props ) => {
    ...
    return (
        <div id="what_we_do_template_four" className="what_we_do_template_four template_main_container_display_area" style={{ backgroundColor:backgroundColor }}>
            ...
            <div className="what_we_do_template_four__middle">
                <div className="image_container_four_wwd">
                    <ImageComponent
            ...
            <div className="what_we_do_template_four__bottom">
                <div className="what_we_do_template_four__bottom_blocks">
                    <div className="what_we_do_template_four__bottom_blocks_left">
                        <IconComponent
                    ...
                    <div className="what_we_do_template_four__bottom_blocks_right">
                        <div className="what_we_do_template_four__bottom_blocks_right__headline_blocks">
                            <TextComponent
                        ...
                        <div className="what_we_do_template_four__bottom_blocks_right__para_blocks">
                            <TextComponent
