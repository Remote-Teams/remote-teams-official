...
export class OurVision_TemplateOne extends Component {
  render() {
    return (
...
export default OurVision_TemplateOne;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      ...
      className="our_vision_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_vision_template_one_left">
        <div className="our_vision_template_one_headline">
          <TextComponent
        ...
        <div className="our_vision_template_one_para">
          <TextComponent
      ...
      <div className="our_vision_template_one_right">
        <ImageComponent
