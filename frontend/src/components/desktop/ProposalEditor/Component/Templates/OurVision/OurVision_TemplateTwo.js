...
export class OurVision_TemplateTwo extends Component {
  render() {
    return (
...
export default OurVision_TemplateTwo;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      ...
      className="our_vision_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_vision_template_two_left">
        <div className="our_vision_template_two_headline">
          <TextComponent
        ...
        <div className="our_vision_template_two_para">
          <TextComponent
      ...
      <div className="our_vision_template_two_right">
        <ImageComponent
