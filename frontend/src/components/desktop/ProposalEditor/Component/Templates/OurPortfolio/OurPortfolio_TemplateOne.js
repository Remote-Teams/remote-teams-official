...
export class OurPortfolio_TemplateOne extends Component {
  render() {
    return (
...
export default OurPortfolio_TemplateOne;
export const TemplateArea = (props) => {
  const backgroundColor = props.template_data.backgroundColor;
  // console.log( props.template_data );
  return (
    <div
      id="our_protfolio_template_one"
      className="our_protfolio_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_protfolio_template_one_headline">
        <TextComponent
      ...
      {/* row 1 */}
      <div className="our_protfolio_template_one_container">
        {/* block 1 */}
        <div className="our_protfolio_template_one_block">
          <div className="our_protfolio_template_one_block_top">
            <div className="our_protfolio_template_one_block_left">
              <ImageComponent
            ...
            <div className="our_protfolio_template_one_block_right">
              <div className="our_protfolio_template_one_block_headline">
                <TextComponent
              ...
              <div className="our_protfolio_template_one_block_headline_two">
                <TextComponent
                  data_text={props.template_data.para_one_headline_two}
                  noEditMode={props.noEditMode}
                  onChange={props.onTemplateEditorChangeHandler(
                    "para_one_headline_two",
                    props.template_index
                  )}
                />
              </div>
          ...
          <div className="our_protfolio_template_one_block_bottom">
            <TextComponent
        ...
        <div className="our_protfolio_template_one_block">
          <div className="our_protfolio_template_one_block_top">
            ...
            <div className="our_protfolio_template_one_block_right">
              ...
              <div className="our_protfolio_template_one_block_headline_two">
                <TextComponent
                  data_text={props.template_data.para_two_headline_two}
                  noEditMode={props.noEditMode}
                  onChange={props.onTemplateEditorChangeHandler(
                    "para_two_headline_two",
                    props.template_index
                  )}
                />
              </div>
        ...
        <div className="our_protfolio_template_one_block">
          <div className="our_protfolio_template_one_block_top">
            ...
            <div className="our_protfolio_template_one_block_right">
              ...
              <div className="our_protfolio_template_one_block_headline_two">
                <TextComponent
                  data_text={props.template_data.para_three_headline_two}
                  noEditMode={props.noEditMode}
                  onChange={props.onTemplateEditorChangeHandler(
                    "para_three_headline_two",
                    props.template_index
                  )}
                />
              </div>
        ...
        <div className="our_protfolio_template_one_block">
          <div className="our_protfolio_template_one_block_top">
            ...
            <div className="our_protfolio_template_one_block_right">
              ...
              <div className="our_protfolio_template_one_block_headline_two">
                <TextComponent
                  data_text={props.template_data.para_four_headline_two}
                  noEditMode={props.noEditMode}
                  onChange={props.onTemplateEditorChangeHandler(
                    "para_four_headline_two",
                    props.template_index
                  )}
                />
              </div>
        ...
        <div className="our_protfolio_template_one_block">
          <div className="our_protfolio_template_one_block_top">
            ...
            <div className="our_protfolio_template_one_block_right">
              ...
              <div className="our_protfolio_template_one_block_headline_two">
                <TextComponent
                  data_text={props.template_data.para_five_headline_two}
                  noEditMode={props.noEditMode}
                  onChange={props.onTemplateEditorChangeHandler(
                    "para_five_headline_two",
                    props.template_index
                  )}
                />
              </div>
        ...
        <div className="our_protfolio_template_one_block">
          <div className="our_protfolio_template_one_block_top">
            ...
            <div className="our_protfolio_template_one_block_right">
              ...
              <div className="our_protfolio_template_one_block_headline_two">
                <TextComponent
                  data_text={props.template_data.para_six_headline_two}
                  noEditMode={props.noEditMode}
                  onChange={props.onTemplateEditorChangeHandler(
                    "para_six_headline_two",
                    props.template_index
                  )}
                />
              </div>
