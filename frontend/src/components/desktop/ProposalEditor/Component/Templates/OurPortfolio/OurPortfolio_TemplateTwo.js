...
export class OurPortfolio_TemplateTwo extends Component {
  render() {
    return (
...
export default OurPortfolio_TemplateTwo;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_protfolio_template_two"
      className="our_protfolio_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_protfolio_template_two_headline">
        <TextComponent
      ...
      <div className="our_protfolio_template_two_bottom">
        <div className="our_protfolio_template_two_bottom_left">
          <ImageComponent
        ...
        <div className="our_protfolio_template_two_bottom_right">
          <div className="our_protfolio_template_two_bottom_para_headline">
            <TextComponent
          ...
          <div className="our_protfolio_template_two_bottom_para">
            <TextComponent
