...
export class ProjectDetails_TemplateTwo extends Component {
  render() {
    return (
...
export default ProjectDetails_TemplateTwo;
...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      <div className="project_details_two_headline">
        <TextComponent
      ...
      <div className="project_details_two_container">
        <div className="project_details_two_left">
          <div className="project_details_two_para_headline">
            <TextComponent
          ...
          <div className="project_details_two_para">
            <TextComponent
        ...
        <div className="project_details_two_img">
          <ImageComponent
