...
export class ProjectDetails_TemplateOne extends Component {
  render() {
    return (
...
export default ProjectDetails_TemplateOne;
  ...
  return (
    ...
    >
      <div className="project_details_one_left">
        <div className="project_details_one_headline">
          <TextComponent
        ...
        <div className="project_details_one_para_headline">
          <TextComponent
        ...
        <div className="project_details_one_para">
          <TextComponent
      ...
      <div className="project_details_one_img">
        <ImageComponent
