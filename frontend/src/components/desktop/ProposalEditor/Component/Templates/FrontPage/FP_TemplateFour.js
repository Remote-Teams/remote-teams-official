...
export const TemplateArea = ( props ) => {
    ...
    return (
        <div id="front_page_template_four" className="front_page_template_four template_main_container_display_area" style={{ backgroundColor:backgroundColor }}>
            <div className="front_page_template_four__top">
              <TextComponent
            ...
            <div className="front_page_template_four__bottom">
                <ImageComponent
