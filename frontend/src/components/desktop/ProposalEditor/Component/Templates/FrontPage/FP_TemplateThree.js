...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      ...
      className="front_page_template_three template_main_container_display_area"
    ...
    >
      ...
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="front_page_template_three_top_line"
        classNameString="lineColor"
        backgroundColor={props.template_data.lineColor}
        onTemplateItemChangeWithoutEvent={
        ...
        {...props}
      />
      <div className="front_page_template_three_para">
        <TextComponent
      ...
      <div className="front_page_template_three__bottom">
        <ImageComponent
