...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      <div className="front_page_template_two__top_logo_area_container">
        {props.template_data.display_logo ? <CompanyLogo {...props} /> : null}
      </div>
      <div className="front_page_template_two__top_headline">
        <TextComponent
      ...
      <div className="front_page_template_two__top_text">
        <TextComponent
      ...
      <div className="front_page_template_two_bottom">
        <ImageComponent
