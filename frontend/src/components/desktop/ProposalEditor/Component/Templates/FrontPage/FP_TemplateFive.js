...
export class FP_TemplateFive extends Component {
  render() {
    return (
...
export default FP_TemplateFive;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="front_page_template_five"
      className="front_page_template_five template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="front_page_template_five__left">
        <ImageComponent
      ...
      <div className="front_page_template_five__right">
        <TextComponent
