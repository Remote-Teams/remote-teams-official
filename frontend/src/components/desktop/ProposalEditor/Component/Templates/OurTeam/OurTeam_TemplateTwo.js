...
export class OurTeam_TemplateTwo extends Component {
  render() {
    return (
...
export default OurTeam_TemplateTwo;
...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      ...
      {/* row 1 */}
      <div className="our_team_template_two_container">
        {/* block 1 */}
        <div className="our_team_template_two_block">
          <div className="our_team_template_two_block_top">
            <ImageComponent
          ...
          <div className="our_team_template_two_block_para">
            <TextComponent
