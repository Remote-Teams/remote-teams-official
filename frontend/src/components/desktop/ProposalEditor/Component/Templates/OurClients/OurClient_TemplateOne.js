...
export class OurClient_TemplateOne extends Component {
  render() {
    return (
...
export default OurClient_TemplateOne;
...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      ...
      {/* row 1 */}
      <div className="our_clients_template_one_container">
        {/* block 1 */}
        <div className="our_clients_template_one_block">
          <div className="our_clients_template_one_block_top">
            <ImageComponent
          ...
          <div className="our_clients_template_one_block_headline">
            <TextComponent
          ...
          <div className="our_clients_template_one_block_para">
            <TextComponent
