...
export class OurClients_TemplateTwo extends Component {
  render() {
    return (
...
export default OurClients_TemplateTwo;
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
        ...
        <div className="our_clients_template_two_left">
          <ImageComponent
        ...
        <div className="our_clients_template_two_right">
        ...
        />
          ...
          <div className="our_clients_template_two_right_container">
            {/*  Block 1 */}
            <div className="our_clients_template_two_block">
              <div className="our_clients_template_two_block_headline">
                <TextComponent
              ...
              <div className="our_clients_template_two_block_para">
                <TextComponent
