...
export class OurCapabilities_TemplateOne extends Component {
  render() {
    return (
...
export default OurCapabilities_TemplateOne;
...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      <div className="our_capabilities_template_one_left">
        <ImageComponent
      ...
      <div className="our_capabilities_template_one_right">
        <div className="our_capabilities_template_one_headline">
          <TextComponent
        ...
        <div className="our_capabilities_template_one_right_container">
          {/*  Block 1 */}
          <div className="our_capabilities_template_one_block">
            <div className="our_capabilities_template_one_block_headline">
              <TextComponent
            ...
            <div className="our_capabilities_template_one_block_para">
              <TextComponent
