...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="om_template_one"
      className="om_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="om_template_one_left">
        <ImageComponent
      ...
      <div className="om_template_one_right">
        <div className="om_template_one_headline">
          <TextComponent
        ...
        <div className="om_template_one_para">
          <TextComponent
