...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="om_template_two"
      className="om_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="om_template_two_left">
        <div className="om_template_two_headline">
          <TextComponent
        ...
        <div className="om_template_two_para">
          <TextComponent
      ...
      <div className="om_template_two_right">
        <ImageComponent
