...
export class OBM_TemplateOne extends Component {
  render() {
    return (
...
export default OBM_TemplateOne;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="obm_template_one"
      className="obm_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="obm_template_one_left">
        <ImageComponent
      ...
      <div className="obm_template_one_right">
        <div className="obm_template_one_headline">
          <TextComponent
        ...
        <div className="obm_template_one_para">
          <TextComponent
