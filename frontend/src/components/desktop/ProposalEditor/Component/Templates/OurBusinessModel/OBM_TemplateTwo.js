...
export class OBM_TemplateTwo extends Component {
  render() {
    return (
...
export default OBM_TemplateTwo;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="obm_template_two"
      className="obm_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="obm_template_two_left">
        <ImageComponent
      ...
      <div className="obm_template_two_right">
        <div className="obm_template_two_headline">
          <TextComponent
        ...
        <div className="obm_template_two_para">
          <TextComponent
