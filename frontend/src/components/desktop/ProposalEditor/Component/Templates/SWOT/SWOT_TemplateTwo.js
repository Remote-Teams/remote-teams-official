...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      <div className="swot_template_two_headline">
        <TextComponent
      ...
      <div className="swot_template_two_bottom">
        ...
        <div className="swot_template_two_bottom_block">
          <div className="swot_template_two_block_top">
            <ImageComponent
          ...
          <div className="swot_template_two_block_headline">
            <TextComponent
          ...
          <div className="swot_template_two_block_para">
            <TextComponent
