...
export const TemplateArea = (props) => {
  ...
  return (
    ...
    >
      <div className="swot_template_one_headline">
        <TextComponent
      ...
      <div className="swot_template_one_bottom">
        {/* left side */}
        <div className="swot_template_one_bottom_block_left">
          {/* left side block one */}
          <div className="swot_template_one_bottom_block_inner">
            <div className="swot_template_one_bottom_block_inner_headline">
              <TextComponent
            ...
            <div className="swot_template_one_bottom_block_inner_para">
              <TextComponent
        ...
        {/* middle block */}
        <div className="swot_template_one_bottom_block_middle">
          <ImageComponent
        ...
        {/* right block */}
        <div className="swot_template_one_bottom_block_right">
          {/* right side block 1 */}
          <div className="swot_template_one_bottom_block_inner">
            <div className="swot_template_one_bottom_block_inner_headline">
              <TextComponent
