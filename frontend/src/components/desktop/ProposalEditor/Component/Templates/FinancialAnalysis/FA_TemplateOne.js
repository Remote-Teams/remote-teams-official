...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="fa_template_one"
      className="fa_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="fa_template_one_headline">
        <TextComponent
      ...
      <div className="fa_template_one_container">
        <div className="fa_template_one_left">
          {/*  Block 1 */}
          <div className="fa_template_one_block_headline">
            <TextComponent
          ...
          <div className="fa_template_one_block_para">
            <TextComponent
        ...
        <div className="fa_template_one_right">
          <ImageComponent
