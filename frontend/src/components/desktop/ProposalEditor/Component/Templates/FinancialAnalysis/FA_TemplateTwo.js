...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="fa_template_two"
      className="fa_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="fa_template_two_headline">
        <TextComponent
      ...
      <div className="fa_template_two_container">
        <div className="fa_template_two_left">
          {/*  Block 1 */}
          <div className="fa_template_two_block_headline">
            <TextComponent
          ...
          <div className="fa_template_two_block_para">
            <TextComponent
        ...
        <div className="fa_template_two_right">
          <ImageComponent
