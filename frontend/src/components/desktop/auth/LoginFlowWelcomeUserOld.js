...
// // const textProjectOrProduct = isLocalStorageOrgCompanyTypeService
// //   ? "project"
// //   : "product";

// export default function LoginFlowWelcomeUserOld() {
...
//   const [yScrollVal, setYScrollVal] = useState(0);
//   const [screenOneHeight, setScreenOneHeight] = useState();
...
//     let screenOneHeight = document.getElementById(
//       "rt-login-welcome-user-company-working-hrs-fold-id"
//     );
//     screenOneHeight =
//       screenOneHeight !== null ? screenOneHeight.offsetHeight : 0;

//     setScreenOneHeight(screenOneHeight);

//     // cleanup on component unmount
//     return () => {
//       window.removeEventListener("load", handleOnLoadPage);
//     };
//   }, []);
...
//       setYScrollVal(window.scrollY);
//     };
//     window.addEventListener("scroll", () =>
//       setTimeout(handleOnScrollPage, 700)
//     );

//     // cleanup on component unmount
//     return () => {
//       window.addEventListener("scroll", () =>
//         clearTimeout(handleOnScrollPage, 700)
//       );
//     };
//   }, [yScrollVal]);

//   // on yScrollVal change
//   useEffect(() => {
//     let screenTwoOffset = screenOneHeight * 3;

//     if (yScrollVal < screenOneHeight / 2) {
//       setScreenNum(0);
//     } else if (
//       yScrollVal > screenOneHeight / 2 &&
//       yScrollVal < screenTwoOffset / 2
//     ) {
//       setScreenNum(1);
//     } else {
//       setScreenNum(2);
//     }
//   }, [yScrollVal, screenOneHeight]);
...
//   const handleOnClickCircle = (num) => (e) => {
//     setScreenNum(num);

//     let screenTwoOffset = screenOneHeight;
//     let screenThreeOffset = screenOneHeight * 2;

//     if (num === 0) {
//       window.scrollTo(0, 0);
//     }
//     if (num === 1) {
//       window.scrollTo(0, screenTwoOffset);
//     }
//     if (num === 2) {
//       window.scrollTo(0, screenThreeOffset);
//     }
//   };
...
//     } else {
//       window.scrollTo(0, screenOneHeight);
//     }
//   };

//   const handleOnClickCoolLetsGo = () => {
//     // console.log(values);
//     window.scrollTo(0, screenOneHeight * 2);
//   };
...
//   const handleOnClickSaveProductData = () => {
//     // console.log(values);
//     if (process.env.NODE_ENV === "development") {
//       window.location.href = `http://localhost:3000/products`;
//     } else {
//       window.location.href = `https://${workspaceId}.remote-teams.io/products`;
//     }
//   };
...
//       <div className="rt-login-welcome-user-project-name">
//         <label htmlFor="projectName" className="font-18-semiBold">
//           What would you like to name your first product?
//         </label>
//         <InputFieldEmailTextPassword
//           containerClassName="container-login-flow-input container-login-flow-input--forms"
//           //label=""
...
//           onChange={handleChange}
//           type="text"
//           // error={values.error.productName}
//         />
//       </div>
//     );
//   };
...
//                 <button
//                   onClick={handleOnClickCircle(data)}
//                   className={
//                     screenNum === data
...
//                 The timings added will help you and your team <br /> in tracking
//                 time better!!
//               </p>
//               <p className="font-18-extraBold color-white-79 rt-wc-user-text-mb">
//                 Why dont we setup a{" "}
//                 {orgDataLocalStorage.companyType === "SERVICE"
//                   ? "project"
//                   : "product"}{" "}
//                 next!!
//               </p>
...
//               <div className="rt-login-welcome-user-content-block">
//                 <h2 className="rt-welcome-user-title-text-2 text-ceneter">
//                   Let&rsquo;s set up your product
//                 </h2>
//                 <div className="rt-login-welcome-user-content-block__content pl-0 text-center">
//                   {/* product name */}
//                   {renderProductName()}
//                   <GreenButtonSmallFont
//                     text="Take me to the Product"
//                     onClick={handleOnClickSaveProductData}
//                     extraClassName="rt-login-welcome-user-details-save-btn"
//                   />
//                 </div>
//               </div>
