...
export class HighchartNetwork extends Component {
  componentDidMount() {
    // Initialize exporting module
    HighchartsExporting(Highcharts);
    HighchartsNetworkgraph(Highcharts);

    Highcharts.chart("network-chart-container", {
      chart: {
        type: "networkgraph",
        height: "100%",
  ...
  render() {
    return <div id="network-chart-container"></div>;
  }
}

export default HighchartNetwork;
