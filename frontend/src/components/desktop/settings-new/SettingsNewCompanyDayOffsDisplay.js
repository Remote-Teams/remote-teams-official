...
export class SettingsNewCompanyDayOffsDisplay extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // login form
  ...
  renderData = () => {
    ...
    return (
      <div className="login-company-day-off__table mt-0">
